...
$ovf_config.Common.nsx_dns1_0.Value ="172.31.0.253" # DNS
$ovf_config.Common.nsx_domain_0.Value = "ad.hlab.com" # Domain search list
$ovf_config.Common.nsx_ntp_0.Value = "172.31.0.23" # NTP
$ovf_config.Common.nsx_isSSHEnabled.Value = $true  # SSH
$ovf_config.Common.nsx_allowSSHRootLogin.Value = $true # Root SSH

#Deploy Parameter
$vm_name = "nsxt-mgr01"
$host_name = "deskmini-a300-01.ad.hlab.com"
$vm_host = (Get-VMHost -Name $host_name)
$datastore = "localds-01"
